...
func (q ListQuery) QueryName() string {
	return "posts/list" // Removed suffix
}
...
func (q *Querier) HandleList(ctx context.Context, query core.Query) (core.QueryResult, error) {
	...
	slog.Debug("Handling ListQuery", "feature", "posts", "page", listQuery.Page, "pageSize", listQuery.PageSize)
	...
	slog.Debug("Successfully processed ListQuery", "feature", "posts", "count", len(results), "total", totalCount)
